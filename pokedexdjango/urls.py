...
urlpatterns = [
    ...
    path('pokemon/remove-favourite/<int:id>/', views.remove_fav_pokemon, name='remove_fav_pokemon'),
    path('pokemon/add-favourite/<int:id>/', views.add_fav_pokemon, name='add_fav_pokemon'),
